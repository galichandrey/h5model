# -*- coding: utf-8 -*-
"""load model - refresh 5 seconds (work-bitcoin-predict-1d)

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1LroX4tYnJi5O-6cXLhe8XFz_f9WDZMaR

docker run amancevice/pandas:alpine -v /root:/root python3 script.py


docker pull amancevice/pandas:alpine
...
#!wget https://raw.githubusercontent.com/NourozR/Stock-Price-Prediction-LSTM/master/preprocessing.py

#!cp /kaggle/input/preprocessing/preprocessing.py /kaggle/working/preprocessing2.py;ls
...
#from preprocessing import new_dataset
import datetime
...
#print ("Close Price right now: ", float(dataset['Close'].tail(2).values))
